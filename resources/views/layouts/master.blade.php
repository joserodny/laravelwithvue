...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
     ...
     <title>{{ config('app.name', 'LaraStart') }}</title>
...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="images/web-page.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <router-link to="/dashboard" class="nav-link">
                  <i class="nav-icon fas fa-home cyan"></i>
                  <p>
                    Dashboard
                  </p>
                </router-link>
          ...
          <li class="nav-item">
            ...
            <i class="nav-icon fas fa-sign-out-alt red"></i> <p>
                {{ __('Logout') }}
            </p>
